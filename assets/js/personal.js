...
var mainAccFilter = document.getElementById('personal-accounts-filter');
...
var actionsFilter = document.getElementById('personal-actions-filter');
...
function openTabs(evt, tableName) {
    ...
    if (document.getElementById("actions-personal").style.display == "block") {
